...
def test_packets_match_the_vendor_app():
    ...
    # A rotation -- pin 1 blue, pin 2 red, pin 3 green -- which is where an
    # inverted reading of this command would finally show itself.
    assert list(Pkt.pin_order(3, 1, 2)) == [0x7E, 0x06, 0x81, 3, 1, 2, 0xFF, 0x00, 0xEF]
